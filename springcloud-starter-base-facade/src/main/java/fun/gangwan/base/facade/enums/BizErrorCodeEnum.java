...
public enum BizErrorCodeEnum implements BizEnum{
    ...
    INVALID_PARAMS(10050, "INVALID_PARAMS", "非法参数请求"),

    ASSERT_ERROR(10101, "ASSERT_ERROR", "断言异常"),
    ...
    SMS_CODE_REQUEST_MORE_THEN_FIVE_TIMES(10203, "SMS_CODE_REQUEST_MORE_THEN_FIVE_TIMES", "短信验证码请求次数过多，请30分钟之后再获取"),
    ...
    FILE_SIZE_LIMIT(11201, "FILE_SIZE_LIMIT", "文件大小超出限制");
